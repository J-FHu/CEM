# This implementation mainly comes from https://github.com/DCurro/CannyEdgePytorch
...
class Net(nn.Module):
    def __init__(self, threshold=10.0, use_cuda=False):
        ...
        generated_filters = np.array([[2, 4, 5, 4, 2],
                                      [4, 9, 12, 9, 4],
                                      [5, 12, 15, 12, 5],
                                      [4, 9, 12, 9, 4],
                                      [2, 4, 5, 4, 2]]) / 159

        self.gaussian_filter_horizontal = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=(5), padding=2)
    ...
    def forward(self, img):
        ...
        blurred_img_r = self.gaussian_filter_horizontal(img_r)
        blurred_img_g = self.gaussian_filter_horizontal(img_g)
        blurred_img_b = self.gaussian_filter_horizontal(img_b)
